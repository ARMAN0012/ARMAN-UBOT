...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╰✠╼━━━━━━❖━━━━━━━✠╯\n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰ \n"
        f"[𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌]({IG_ALIVE}instagram.com/arman_nasution123) || [{REPO_NAME}](https://github.com/ARMAN0012/ARMAN-UBOT) || [𝐆𝐑𝐎𝐔𝐏]({GROUP_LINK}https://t.me/obrolansuar) \n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"❃ **Modul**           ➥ `{len(modules)}` \n\n"
        f"**▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰**\n"
        f"[{REPO_NAME}](https://github.com/ARMAN0012/ARMAN-UBOT) || [𝗚𝗥𝗢𝗨𝗣]({GROUP_LINK}https://t.me/obrolansuar) || [𝗜𝗡𝗦𝗧𝗔𝗚𝗥𝗔𝗠]({IG_ALIVE}instagram.com/arman_nasution123)\n"
        f"**▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰ **")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╰✠╼━━━━━━❖━━━━━━━✠╯ \n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰ \n"
        f"[{REPO_NAME}](https://github.com/ARMAN0012/ARMAN-UBOT) || [𝐆𝐑𝐎𝐔𝐏]({GROUP_LINK}https://t.me/obrolansuar) || [𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌]({IG_ALIVE}instagram.com/arman_nasution123) \n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
